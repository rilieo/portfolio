    ...
    w-full flex items-center py-5 fixed top-0 z-20 bg-primary`}>
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        <ul className='list-none hidden sm:flex flex-row gap-10'>
          ...
          {/* <li>
            <div className="fixed flex flex-row justify-center items-center z-99999999">
              ...
              <button className="cursor-pointer relative w-[56px] h-[28px] flex justify-center items-center bg-white rounded-full my-0 mx-16 border-none shadow-xl">
                <div className="absolute left-[6px] rounded-xl w-[20px] h-[20px] transition ease-in-out duration-0.2s bg-black hover:scale-90">
                </div>
              </button>
              <div className="flex flex-row justify-center items-center bg-white">
